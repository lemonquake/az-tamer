...
export const CLOTHES_DATABASE: Record<string, ClothesItem> = {
  ...
  // ---- 10 NEW SPECIAL RARE PANTS ----
  terra_cog_pants: { id: 'terra_cog_pants', name: 'Steampunk Cog Trousers', slot: 'pants', price: 7800, desc: 'Plated legs with rotating brass gears on the thighs.', color: 0x8a7a5a, terra: true, fx: { kind: 'cog_pants', color: 0xd9a11a } },
  terra_ninja_pants: { id: 'terra_ninja_pants', name: 'Shadow Shinobi Hakama', slot: 'pants', price: 5500, desc: 'Flowing dark hakama with long swaying ribbons.', color: 0x111116, terra: true, fx: { kind: 'ninja_pants', color: 0xff3333 } },
  terra_matrix_pants: { id: 'terra_matrix_pants', name: 'Hacker Matrix Pants', slot: 'pants', price: 9500, desc: 'Trousers with cascading digital matrix rain.', color: 0x112211, terra: true, fx: { kind: 'matrix_pants', color: 0x33ff33 } },
  terra_aether_pants: { id: 'terra_aether_pants', name: 'Aether-Plate Greaves', slot: 'pants', price: 14500, desc: 'Floating cyan energy shields guarding your shins.', color: 0x113355, terra: true, fx: { kind: 'aether_pants', color: 0x33aaff } },
  terra_lava_pants: { id: 'terra_lava_pants', name: 'Infernal Lava Trousers', slot: 'pants', price: 13000, desc: 'Molten seams that crackle and shed rising embers.', color: 0x221105, terra: true, fx: { kind: 'lava_pants', color: 0xff5500 } },
  terra_frost_pants: { id: 'terra_frost_pants', name: 'Glacial Frost Trousers', slot: 'pants', price: 12500, desc: 'Frosted leggings leaving a trail of chilly snow particles.', color: 0x113344, terra: true, fx: { kind: 'frost_pants', color: 0x88ddff } },
  terra_gilded_pants: { id: 'terra_gilded_pants', name: 'Gilded Sovereign Greaves', slot: 'pants', price: 11000, desc: 'Shining gold plates with sweeping bright light highlights.', color: 0xd9a11a, terra: true, fx: { kind: 'gilded_pants', color: 0xffd700 } },
  terra_bone_pants: { id: 'terra_bone_pants', name: 'Skeletal Crypt-Legs', slot: 'pants', price: 8500, desc: 'Hardened dragon bone ribs wrapping around your legs.', color: 0xeeeeee, terra: true, fx: { kind: 'bone_pants', color: 0xddddcc } },
  terra_toxic_pants: { id: 'terra_toxic_pants', name: 'Noxious Acid Trousers', slot: 'pants', price: 11500, desc: 'Pipes containing bubbling and pulsing neon-green acid.', color: 0x112211, terra: true, fx: { kind: 'toxic_pants', color: 0x99ff33 } },
  terra_slime_pants: { id: 'terra_slime_pants', name: 'Bouncy Slime Trousers', slot: 'pants', price: 7500, desc: 'Jelly pants that squish and emit green slime drops.', color: 0x225522, terra: true, fx: { kind: 'slime_pants', color: 0x66ff66 } },

  // ---- 10 NEW ULTRA RARE TOURNAMENT SHIRTS ----
  ult_champ_cloak: { id: 'ult_champ_cloak', name: 'Finals Champion Cloak', slot: 'shirt', price: 0, desc: 'Crimson-and-gold armor with a long flowing velvet champion cape.', color: 0x6a0f12, ultra: true, ultraSource: 'tournament', fx: { kind: 'champ_cloak', color: 0xffd700 } },
  ult_void_nova: { id: 'ult_void_nova', name: 'Void-Nova Harness', slot: 'shirt', price: 0, desc: 'Exo-harness cradling a mini black hole drawing in violet light.', color: 0x11081c, ultra: true, ultraSource: 'tournament', fx: { kind: 'void_nova', color: 0xa855ff } },
  ult_aether_lord: { id: 'ult_aether_lord', name: 'Aether-Lord Plate', slot: 'shirt', price: 0, desc: 'Heavy white plate armor with floating cyan pauldrons.', color: 0xeeeeee, ultra: true, ultraSource: 'tournament', fx: { kind: 'aether_lord', color: 0x33ccff } },
  ult_dragon_armor: { id: 'ult_dragon_armor', name: 'Draconic Fury Carapace', slot: 'shirt', price: 0, desc: 'Obsidian dragon-scale armor venting orange jets of lava fire.', color: 0x220a05, ultra: true, ultraSource: 'tournament', fx: { kind: 'dragon_armor', color: 0xff5500 } },
  ult_cyber_matrix: { id: 'ult_cyber_matrix', name: 'Cyber-Overlord Matrix', slot: 'shirt', price: 0, desc: 'Exoframe bodysuit veined with streaming green terminal code.', color: 0x051a05, ultra: true, ultraSource: 'tournament', fx: { kind: 'cyber_matrix', color: 0x33ff33 } },
  ult_frost_emperor: { id: 'ult_frost_emperor', name: 'Glacial Emperor Plate', slot: 'shirt', price: 0, desc: 'Ice-spiked shoulder plates with a swirling sub-zero blizzard aura.', color: 0x0a1e2a, ultra: true, ultraSource: 'tournament', fx: { kind: 'frost_emperor', color: 0x88ddff } },
  ult_cosmic_singularity: { id: 'ult_cosmic_singularity', name: 'Cosmic Singularity Plate', slot: 'shirt', price: 0, desc: 'Plated space-armor containing a rotating blue spiral galaxy.', color: 0x09061a, ultra: true, ultraSource: 'tournament', fx: { kind: 'cosmic_singularity', color: 0x33aaff } },
  ult_tesla_rig: { id: 'ult_tesla_rig', name: 'High-Voltage Tesla Rig', slot: 'shirt', price: 0, desc: 'Electric generators sending snapping blue lightning arcs.', color: 0x1a1a24, ultra: true, ultraSource: 'tournament', fx: { kind: 'tesla_rig', color: 0x33ccff } },
  ult_angel_plate: { id: 'ult_angel_plate', name: 'Archangel Battle-Plate', slot: 'shirt', price: 0, desc: 'Silver plate armor with beating glowing white holographic wings.', color: 0xdddddd, ultra: true, ultraSource: 'tournament', fx: { kind: 'angel_plate', color: 0xffffff } },
  ult_lumen_robes: { id: 'ult_lumen_robes', name: 'Lumenwright Sage Robes', slot: 'shirt', price: 0, desc: 'Elegant golden robes with orbiting magical yellow runes.', color: 0x4a3c10, ultra: true, ultraSource: 'tournament', fx: { kind: 'lumen_robes', color: 0xffd23a } },
};
