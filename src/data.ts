...
export type TechEffect = 'damage' | 'heal' | 'buffAtk' | 'buffDef' | 'debuffDef' | 'debuffSpd' | 'drain';
...
export const DUNGEONS: DungeonDef[] = [
  { id: 'trial', name: 'Trial Caverns', floors: 2, levelRange: [3, 5], theme: 'cavern',
    pool: ['pebblit', 'cinderbat', 'gloomite', 'sparkmote', 'ashwisp', 'cryptling'], boss: 'ironhusk', bossLevel: 7, rewardShards: 300,
  ...
  { id: 'mossdeep', name: 'Mossdeep Burrows', floors: 3, levelRange: [2, 5], theme: 'cavern',
    pool: ['pebblit', 'sproutle', 'mistling', 'zephlet', 'gloomite', 'fernfox', 'shroomple', 'plumelet', 'coralkit', 'joltuft'], rewardShards: 250,
  ...
  { id: 'sunken', name: 'Sunken Vault', floors: 4, levelRange: [9, 14], theme: 'vault',
    pool: ['mistling', 'gloomite', 'cinderbat', 'puddla', 'shadekit', 'sparkmote', 'frostfin', 'coralkit', 'mournmoth', 'driftling', 'reefrider'], boss: 'gravemaw', bossLevel: 17, rewardShards: 900, unlockFlag: 'joined_house',
