...
const DOSSIERS: Record<string, Omit<NpcProfile, 'name'>> = {
  ...
  'Master Bren': {
    title: 'Grandmaster of House Pyrelight', houseId: 'pyrelight', rank: 'Guildmaster',
  ...
  'Mistress Sera': {
    title: 'Grandmaster of House Mistveil', houseId: 'mistveil', rank: 'Guildmaster',
  ...
  'Warden Oakes': {
    title: 'Grandmaster of House Thornward', houseId: 'thornward', rank: 'Guildmaster',
  ...
  'Captain Vex': {
    title: 'Grandmaster of House Stormcall', houseId: 'stormcall', rank: 'Guildmaster',
  ...
  'Keeper Nyx': {
    title: 'Grandmaster of House Duskwatch', houseId: 'duskwatch', rank: 'Guildmaster',
  ...
  'Guide Mara': {
    title: 'Guild Guide of Haven City', guild: { name: 'Haven Guild Authority', color: '#f2c14e', epithet: 'The Open Door' }, rank: 'Senior Liaison',
  ...
  'Dax': {
    title: 'Master Mechanic of the Garage', houseId: 'stormcall', rank: 'Honorary Engineer',
  ...
  'Sanctum Keeper': {
    title: 'Keeper of the Healing Sanctum', guild: { name: 'The Verdant Charity', color: '#5ad88a', epithet: 'Hands That Mend' }, rank: 'High Keeper',
  ...
  'Madame Celeste': {
    title: 'Proprietor of the Boutique',
  ...
  'Tilda the Baker': {
    title: 'Baker of the Morning Bell',
  ...
  'Old Benn': {
    title: 'Legion War Veteran', guild: { name: 'The Lantern Row Veterans', color: '#c4822a', epithet: 'They Held the Ladders' }, rank: 'Sergeant (ret.)',
  ...
  'Joss the Courier': {
    title: 'Fastest Courier in Olivar',
  ...
  'Sera Plum': {
    title: 'Keeper of the Flowerbeds',
  ...
  'Marek the Wallguard': {
    title: 'Warden of the East Wall', guild: { name: 'Haven City Watch', color: '#8a93a8', epithet: 'The Wall Holds' }, rank: 'Wall Sergeant',
  ...
  'Nyla the Stargazer': {
    title: 'Astronomer of the Night Roads',
  ...
  'Little Pip': {
    title: 'Future Three-Guardian Champion (self-certified)',
  ...
  'Ferryn the Miller': {
    title: 'Miller of the Windmill Hill',
  ...
  'Reza the Angler': {
    title: 'Angler of the Worldroot Pond',
  ...
  'Bram the Mason': {
    title: 'Mason of the Grand Stairs',
  ...
  'Wisp-Keeper Yola': {
    title: 'Lamplighter of Haven City',
  ...
  'Azrin': {
    title: 'The Emberlark · Daughter of the Dawnflame', guild: { name: "The Dawnflame's Line", color: '#f2884e', epithet: 'Sunrise, Sudden and Everywhere' }, rank: 'Legend-Blood',
  ...
  'Azrael': {
    title: 'The Nightwing · Daughter of the Dawnflame', guild: { name: "The Dawnflame's Line", color: '#9a6af2', epithet: 'The Lantern, Unlit, For Ghandra' }, rank: 'Legend-Blood',
  ...
  'Mama Imee': {
    title: 'Keeper of the Stew-Fire', guild: { name: 'Circle of the First Fire', color: '#f2a64e', epithet: 'The Oldest Guild in the World' }, rank: 'Hearthkeeper',
  ...
  'Elder Toto': {
    title: 'Elder of the First Fire', guild: { name: 'Circle of the First Fire', color: '#f2a64e', epithet: 'The Oldest Guild in the World' }, rank: 'Elder',
  ...
  'Ring Guard': {
    title: 'Guardian of the Sealed Ring', guild: { name: 'Haven City Watch', color: '#8a93a8', epithet: 'The Wall Holds' }, rank: 'Coliseum Guard',
  ...
  'Liko': {
    title: 'Keeper of the Left Gate', guild: { name: 'Circle of the First Fire', color: '#f2a64e', epithet: 'The Oldest Guild in the World' }, rank: 'Gatekeeper',
  ...
  'Dario': {
    title: 'Tender of the First Fire', guild: { name: 'Circle of the First Fire', color: '#f2a64e', epithet: 'The Oldest Guild in the World' }, rank: 'Fire-Tender',
  ...
  'Ivan Lawrence': {
    title: 'Four-Time Intercontinental Champion · The Man They Broke First', guild: { name: 'Hall of Legends', color: '#c4822a', epithet: 'Cleared. Loudly.' }, rank: '4× Intercontinental Champion',
  ...
  'Relay-Keeper Esta': {
    title: 'Keeper of the Valley Relay', guild: { name: 'The Relay-Keepers\' Round', color: '#5ab8e8', epithet: 'The Signal Is Sacred' }, rank: 'Tower Keeper',
  ...
  'Greggy the Stormheart': {
    title: 'Legendary Tamer · The Stormheart', guild: { name: 'Hall of Legends', color: '#f2d23a', epithet: 'Nine Lights Against Nine Generals' }, rank: '9× World Champion',
...
export function profileFor(name: string): NpcProfile {
  ...
  if (att) {
    return {
      name, houseId: att.id, rank: 'Hall Attendant',
